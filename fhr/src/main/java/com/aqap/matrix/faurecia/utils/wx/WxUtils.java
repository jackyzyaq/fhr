...
import com.consultech.matrix.wechat.WeChat;
...
public class WxUtils {
	...
	private static  String appid = Function.getEnvironment("app_id"); 
	private static  String secret = Function.getEnvironment("app_secret");
	...
	public static void initWeixinJs(HttpServletRequest request) {
		...
		Map<String, String> info = Sign.sign(WxUtils.getJsapiTicketResult(), url.toString());
